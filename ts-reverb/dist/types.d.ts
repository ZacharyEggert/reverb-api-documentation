...
export declare class ReverbApiError extends Error {
    status: number;
...
export interface RefundRequestPayload {
    ...
    reason?: "buyer_return" | "lost_shipment" | "shipping_damage" | "sold_elsewhere" | "accidental_order" | "change_shipping_address" | "shipping_adjustments" | string;
    refund_amount?: {
        amount: string | number;
        currency: string;
    };
